...
import { ExternalLink, Github, Mail, Phone, MapPin, Linkedin, ArrowUp, MessageCircle, Award } from 'lucide-react'
...
export default function PortfolioPage() {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground bg-animated-gradient">
      ...
      {certificates.length > 0 && (
        <section id="certificates" className="py-20 px-4 sm:px-6 lg:px-8 border-t border-border/40">
          <div className="container mx-auto max-w-6xl">
            <div className="flex items-center gap-4 mb-8">
